  ...
  return (
    <section id="about" className="py-16 md:py-24 bg-muted">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div> {/* Main container for stacking Education and Courses */}
          <Card className="shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 hover:bg-card/90 dark:hover:bg-card/80 mb-8">
            <CardHeader>
