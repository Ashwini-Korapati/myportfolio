      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
          <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <CardContent className="space-y-6">
              {education.map((edu, index) => (
                <div key={index} className="p-4 border rounded-lg bg-background hover:bg-secondary/50 transition-colors duration-200">
          ...
          <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <CardContent>
              <div className="p-4 border rounded-lg bg-background hover:bg-secondary/50 transition-colors duration-200">
